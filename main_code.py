...
# Step 6: Monte Carlo Simulation with Returns
# Convert predictions to percentage returns
...
for _ in range(num_simulations):
    simulated_daily_returns = np.random.choice(returns_unscaled.flatten(), size=trading_days, replace=True)
